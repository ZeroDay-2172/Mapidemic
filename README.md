...
- Improved graph page functionality by adding a time range picker, as well as a locality picker to reduce confusion, as well as resolving a bug where switching app themes would not apply it to the graph.
